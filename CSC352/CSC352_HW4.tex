...
\section*{Question 2}
    ...
    in each row is $n(n-1)$. Since there are total $m$ rows, the total number of flops will be $$(n^2m - nm)$$
    ...
    for each entries, the number of flops will be $n$ multiplication and $n-1$ addition, which is $n(n-1)$.\\
    So the total number of flops for matrix times matrix will be $$n^2mp - nmp$$
    \subsection*{(c)}
